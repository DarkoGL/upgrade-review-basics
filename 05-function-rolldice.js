...
// Si no se te ocurre como hacer un numero aleatorio no te preocupes! busca información sobre la función de javascript 

// **Math.random();**

const rollDice = (caras) => Math.ceil(Math.random()*caras);
